    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الطلبات قيد المعالجة</span>
            </div>
        </div>
    </div>
@endsection
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('orders.update-status', $order->id) }}"
                                                ...
                                                @method('PATCH')
                                                <select name="status"
                                                        class="badge badge-info border-0 status-dropdown"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="10" class="text-center py-5">
                                            <i class="fas fa-cogs fa-3x text-info mb-3 d-block"></i>
                                            <h5 class="text-muted">لا توجد طلبات قيد المعالجة</h5>
                                            <p class="text-muted">الطلبات ستظهر هنا عند بدء معالجتها</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
